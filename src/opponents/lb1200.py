# PORTED YARDSTICK — do not edit. A stronger ladder opponent (L2,
# docs/issues/eval/L2-stronger-ladder-tier.md), copied verbatim from the analysed
# corpus so brains can be measured against competent play above the 685 Boss.
#   source : clean_scripts/lb_1200_orbit_wars_ppo_strategy.py
#   catalogue LB : 815.9
# Self-contained, stdlib-only, top-level agent(obs, config); does NOT import the
# solution package, so it runs as a file-path agent in the arena (vetted: clean in
# 1v1 + 4P, no faults). The original module docstring follows.
