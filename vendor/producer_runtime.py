# ===========================================================================
# VENDORED — "The Producer" runtime by slawekbiel, UNMODIFIED.
#   source: Kaggle notebook 'the-producer-agent' (public Orbit Wars submission)
#   This is the notebook's main.py verbatim. It is our agent's BASE; genuine
#   contributions are layered on top in separate, documented changes (per the
#   author's 'before you fork' request). It adds its own dir to sys.path and
#   imports the sibling `orbit_lite` package (vendor/orbit_lite/). Entry: agent().
# ===========================================================================
